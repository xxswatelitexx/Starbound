...
function inspectAction.update(dt, stateData)
  ...
  if stateData.inspectTimer < 0 then
    ...
    if stateData.targetType == "itemdrop" or (stateData.targetType == "object" and stateData.targetName == "foodbowl") then
...
function inspectAction.inspectPlayer(stateData)
  local uuid = world.entityUuid(stateData.inspectTarget)
